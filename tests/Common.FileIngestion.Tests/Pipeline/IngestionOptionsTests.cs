...
public sealed class IngestionOptionsTests
{
    ...
    {
        var options = new IngestionOptions(500, 200_000, 32, 4);
    ...
    [InlineData(1, 1, 0, 1)]
    [InlineData(1, 1, 1, 0)]
    public void Constructor_InvalidValue_Throws(int maxRecords, int maxContentBytes, int channelCapacity, int publishers) =>
        Assert.Throws<ArgumentOutOfRangeException>(
            () => new IngestionOptions(maxRecords, maxContentBytes, channelCapacity, publishers));
}
